...
public class SignalingHandler extends TextWebSocketHandler {
        ...
        try {
            ...
            switch (message.getType()) {
                ...
                case MSG_TYPE_JOIN_ROOM:
                    ...
                    log.info(">>> [ws] 본인 {} 을 제외한 #{}번 방의 다른 유저들 {}", userUUID, roomId, gameRoomService.getAllGameRoomUsersExceptMe(roomId, userUUID));
                    ...
                    session.sendMessage(new TextMessage(Utils.getString(Message.builder()
                            ...
                            .allUsers(gameRoomService.getAllGameRoomUsersExceptMe(roomId, userUUID))
                ...
                case MSG_TYPE_TOGGLE_READY:
                    ...
                    // 접속한 유저의 roomId와 userUUID 를 service 에 넘겨서 status 변경
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) {
        ...
        String userUUID = session.getId();                     // 유저 uuid
        Long gameRoomId = gameRoomService.getRoomId(userUUID); // roomId
